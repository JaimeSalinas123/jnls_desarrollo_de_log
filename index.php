<?php
    ...
    // Obtener IP cliente y estandarizar localhost
    ...
    $ip = ip_in_ranges($ip_cliente, $rango);
?>
<!DOCTYPE html>
<html lang="es-SV">
    <head>
    ...
    <body>
<?php
    // Línea para depurar: mostrar IP remota
    echo '<pre>';
    ...
    switch($status){
        ...
        case "8":
            ...
            // Registrar log de redirección exitosa
            crear_editar_log(
                $archivo,
...
<?php
    if($ip === true){
        // Guardar el log de carga del archivo
        crear_editar_log(
            $archivo,
...
?>
        <div class="form-row">
            ...
            <div class="form-group col-md-5 ml-4 mr-4 justify-content-center align-self-center">
                ...
                <form name="frm_iniciar_sesion" id="frm_iniciar_sesion" 
      action="<?php echo htmlspecialchars("http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"); ?>" 
      method="post">
